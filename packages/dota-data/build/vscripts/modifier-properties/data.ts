...
export const modifierPropertyData: Record<string, [ArgumentType, ReturnsType, string?]> = {
  ...
  // https://github.com/TypeScriptToLua/Dota2Declarations/blob/07ebef180964d0a4058b37d3a8f90e1df90eaf1b/dota-modifier-properties.d.ts
  ...
  GetModifierStatusResistance: ['void', 'number', 'Not working.'],
  GetModifierStatusResistanceStacking: ['void', 'number', 'Not working.'],
