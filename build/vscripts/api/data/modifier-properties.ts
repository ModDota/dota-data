...
const modifiersData: Record<string, [ArgumentType, apiTypes.Type[], string?]> = {
  ...
  OnMagicDamageCalculated: ['ModifierAttackEvent', ['nil']],
  ...
  OnHeroBeginDying: ['ModifierAttackEvent', ['nil']],
  ...
  OnModifierRefreshed: ['ModifierAddedEvent', ['nil']],
  OnModifierRemoved: ['ModifierAddedEvent', ['nil']],
