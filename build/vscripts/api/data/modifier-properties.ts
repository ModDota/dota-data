...
const modifiersData: Record<string, [ArgumentType, apiTypes.Type[], string?]> = {
  ...
  GetModifierIncomingDamageConstant: ['ModifierAttackEvent', anyNumber, "This property controls 'universal' shield, if defined both on client and server. Return value on client should be current shield health, as a positive integer, on server - amount of damage blocked."],
  GetModifierIncomingPhysicalDamage_Percentage: ['ModifierAttackEvent', anyNumber],
  GetModifierIncomingPhysicalDamageConstant: ['ModifierAttackEvent', anyNumber,  "This property controls 'physical' shield, if defined both on client and server. Return value on client should be current shield health, as a positive integer, on server - amount of damage blocked."],
  GetModifierIncomingSpellDamageConstant: ['ModifierAttackEvent', anyNumber,  "This property controls 'spell' shield, if defined both on client and server. Return value on client should be current shield health, as a positive integer, on server - amount of damage blocked."],
