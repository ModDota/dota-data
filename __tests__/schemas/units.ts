...
describe('integration', () => {
  createIntegrationTest({
    ...
    url: 'https://raw.githubusercontent.com/SteamDatabase/GameTracking-Dota2/master/game/dota/scripts/npc/npc_units.txt',
  });
  ...
  createIntegrationTest({
    ...
    url: 'https://raw.githubusercontent.com/SteamDatabase/GameTracking-Dota2/master/game/dota_addons/frostivus_2017/scripts/npc/npc_units_custom.txt',
  });

  createIntegrationTest({
    name: 'frostivus_2017 heroes',
    schema: schemas.npc_heroes_custom,
    url: 'https://raw.githubusercontent.com/SteamDatabase/GameTracking-Dota2/master/game/dota_addons/frostivus_2017/scripts/npc/npc_heroes_custom.txt',
  });
});
